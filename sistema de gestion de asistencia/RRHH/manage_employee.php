...
<div class="container-fluid">
	<form id='employee_frm'>
		...
		<div class="form-group">
			...
			<input type="text" name="username" required="required" class="form-control" value="<?php echo isset($username) ? $username : "" ?>" />
		</div>
		<div class="form-group">
			<label>Password:</label>
			<input type="text" name="password" required="required" class="form-control" value="<?php echo isset($password) ? $password : "" ?>" />
		</div>
	</form>
</div>
<script>
